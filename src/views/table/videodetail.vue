        ...
        <el-card class="box-card" :body-style="{ padding: '5px 0px 10px 0px' }">
          ...
          >
            <el-row :gutter="20" style="margin-bottom: 12px">
              ...
              <el-col :span="14" style="font-weight: normal">
                <div>Sphere1</div>
              </el-col>
            </el-row>
            <el-row :gutter="20" style="margin-bottom: 12px">
            ...
            <el-row :gutter="20" style="margin-bottom: 12px">
              ...
              <el-col :span="14" style="font-weight: normal">
                <div>
                  <el-button type="text">0000000A</el-button>
                </div>
              </el-col>
            </el-row>
            <el-row :gutter="20" style="margin-bottom: 12px">
      ...
      <el-col :span="17">
        <el-card class="box-card" :body-style="{ padding: '5px 0px 10px 0px' }">
          <el-row
            ...
            "
          >
            <el-col :span="8"> <p style="font-size: 16px">撮影情报</p></el-col>
          ...
          <el-divider></el-divider>
          <div style="padding: 0px 0px 60px 20px; margin-top: -15px；">
            <div>
              <el-row :gutter="30" style="font-size: 16px">
                <el-col :span="10">
