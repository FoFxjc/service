  ...
  <div class="dashboard-container">
    <el-card class="box-card" :body-style="{ padding: '5px 0px 10px 0px' }">
      <el-row
        ...
        "
      >
        <el-col :span="8"> <p style="font-size: 16px">情报</p></el-col>
    ...
    <el-card class="box-card" :body-style="{ padding: '5px 0px 10px 0px' }">
      <el-row
        ...
        "
      >
        <el-col :span="8"> <p style="font-size: 16px">支付情报</p></el-col>
      </el-row>
      <el-divider></el-divider>
      <div style="padding: 0px 10px 10px 10px; margin-top: -15px">
        <el-table
          ...
          border
        >
          <el-table-column prop="payment_time" label="时间"> </el-table-column>
          <el-table-column prop="appointment_id" label="预约">
            <template slot-scope="scope">
              <el-button type="text">{{ scope.row.appointment_id }}</el-button>
            </template>
          </el-table-column>
    ...
    <el-card class="box-card" :body-style="{ padding: '5px 0px 10px 0px' }">
      <el-row
        ...
        "
      >
        <el-col :span="8"> <p style="font-size: 16px">通知履历</p></el-col>
      </el-row>
      <el-divider></el-divider>
      <div style="padding: 0px 10px 10px 10px; margin-top: -15px">
        <el-table
